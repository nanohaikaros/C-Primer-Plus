...
// 操作：向树中添加一个项目
// 操作前：pi是待添加的项目的地址 ptree指向一个已初始化的树
// 操作后：如果可能，函数把该项目添加到树中并返回true；否则函数返回false
...
// 操作后：如果可能，函数从树中删除该项目并返回true；否则函数返回false
bool DeleteItem(const Item * pi, Tree * ptree);

// 操作：把一个函数作用于树中每一个项目
// 操作前：ptree指向一棵树pfun指向一个没有返回值的函数该函数接受一个Item作为参数
